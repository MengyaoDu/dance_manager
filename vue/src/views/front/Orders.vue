<template>
  <div class="main-content">
    <div style="width: 80%;margin: 20px auto">
      <div style="font-size: 17px;color: #666666">我的团课预约记录({{total}})</div>
      <div style="margin-top: 20px">
        <el-table :data="tableData" stripe >
          ...
          <el-table-column prop="teacherName" label="导师姓名" show-overflow-tooltip>
            <template v-slot="scope">
              <a :href="'/front/teacherDetail?id=' + scope.row.teacherId">{{scope.row.teacherName}}</a>
            </template>
          </el-table-column>
