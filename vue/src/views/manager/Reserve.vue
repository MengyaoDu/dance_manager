<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入老师姓名" style="width: 200px" v-model="teacherName"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe >
        ...
        <el-table-column prop="teacherName" label="预约老师" show-overflow-tooltip></el-table-column>
