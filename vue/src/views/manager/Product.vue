  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="img" label="产品封面" show-overflow-tooltip>
        ...
        <el-table-column prop="content" label="产品内容" show-overflow-tooltip>
          <template v-slot="scope">
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="60%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="img" label="产品封面">
          <el-upload
        ...
        <el-form-item prop="content" label="产品介绍">
          <div id="editor"></div>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="产品介绍" :visible.sync="viewVisible" width="55%" :close-on-click-modal="false" destroy-on-close>
